...
agent_a2c_instance = create_or_load_a2c_agent(games=100001, other_ai=choose_agent)
...
agent_ppo_instance = create_or_load_ppo_agent(games=100004, other_ai=choose_agent)
...
def choose_agent_2(board, action_set):
    agents = [agent_random, agent_a2c, agent_ppo]
    current_agent = random.choice(agents)
    return current_agent(board, action_set)

agent_a2c_instance = create_or_load_a2c_agent(games=100002, other_ai=choose_agent_2)
